...
function process_mouse(unsplitParentFolder)
    ...
    for iMarcster = 1:numMarcsters
        ...
        for iTrial = 1:numSessions
            ...
            Muzzio_Colours = marcster.clusterColours;
            Muzzio_Clusters = {};
            for iCluster = 1:numClusters
                Muzzio_Clusters{iCluster} = marcster.trialClusterData{iCluster, iTrial};
            end

            outputFolder = fullfile(splitParentFolder, sessionNames{iTrial});
            ofn = fullfile(outputFolder, sprintf('%s.muzzis', tetrodeName));
